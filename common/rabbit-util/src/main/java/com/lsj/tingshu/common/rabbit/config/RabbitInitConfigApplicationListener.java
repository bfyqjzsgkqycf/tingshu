package com.lsj.tingshu.common.rabbit.config;

import com.alibaba.fastjson.JSON;
import com.lsj.tingshu.common.rabbit.entity.TingShuCorrelationData;
...
public class RabbitInitConfigApplicationListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private void setupCallbacks() {
        ...
        this.rabbitTemplate.setReturnsCallback(returned -> {
            ...
            TingShuCorrelationData guiguCorrelationData = JSON.parseObject(correlationDataStr, TingShuCorrelationData.class);
    ...
    private void retrySendMsg(CorrelationData correlationData) {
        //获取相关数据
        TingShuCorrelationData gmallCorrelationData = (TingShuCorrelationData) correlationData;
