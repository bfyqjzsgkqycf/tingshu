package com.lsj.tingshu.common.rabbit.constant;
...
public class MqConst {
    ...
    public static final String ROUTING_TRACK_COLLECT_UPDATE = "tingshu.track.collect.update";
    public static final String QUEUE_TRACK_STAT_UPDATE = "tingshu.track.stat.update";
    public static final String QUEUE_TRACK_COLLECT_UPDATE = "tingshu.track.collect.update";
     ...
     * 用户
     */
    public static final String EXCHANGE_USER = "tingshu.user.exchange";
    public static final String ROUTING_USER_PAY_RECORD  = "tingshu.user.pay.record";
    public static final String ROUTING_USER_REGISTER  = "tingshu.user.register.rk";
    ...
    public static final String QUEUE_USER_REGISTER  = "tingshu.user.register.queue";
     ...
     * 本地消息表
     */
    public static final String EXCHANGE_LOCAL_MSG = "tingshu.local.msg.exchange";
    public static final String ROUTING_LOCAL_MSG = "tingshu.local.msg.rk";
    public static final String QUEUE_LOCAL_MSG  = "tingshu.local.msg.queue";

    /**
     * Es专辑统计类型修改
     */
    public static final String EXCHANGE_ES_UPDATE = "tingshu.es.update.exchange";
    public static final String ROUTING_ES_UPDATE= "tingshu.es.update.rk";
    public static final String QUEUE_ES_UPDATE = "tingshu.es.update.queue";
