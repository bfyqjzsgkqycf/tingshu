package com.lsj.tingshu.common.service.constant;
...
public class RedisConstant {
    ...
    //用户登录
    public static final String USER_LOGIN_KEY_PREFIX = "user:login:access:";
    ...
    public static final String TRACK_STAT_KEY_PREFIX = "track:stat:";
}
